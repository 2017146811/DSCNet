...
class CAA(BaseModule):
    ...
    def forward(self, x):
        attn_factor = self.act(self.conv2(self.gcsa(self.conv1(self.avg_pool(x)))))
        return attn_factor
...
class InceptionBottleneck(BaseModule):
    ...
    def __init__(
        ...
        self.KAN = KANBlock(dim=hidden_channels, drop=drop_rate, drop_path=drop_path, norm_layer=norm_layer)
