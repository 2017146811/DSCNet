...
class FlashDeformAttn(nn.Module):
    def __init__(self, d_model=256, n_levels=4, n_heads=8, n_points=4):
        ...
        :param n_heads      number of network heads
        :param n_points     number of sampling points per network head per feature level
        """
        super().__init__()
        ...
        if not _is_power_of_2(_d_per_head):
            warnings.warn(
                "You'd better set d_model in MSDeformAttn to make the dimension of each network head a power of 2 "
